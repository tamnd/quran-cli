...
Most of these come down to network reality or how quran serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

quran rate-limits like any public site. quran already paces
...
Where a surface is gated, quran reads a cookie or token you supply
...
`quran`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what quran actually did
