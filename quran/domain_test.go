...
func TestHostWiring(t *testing.T) {
	...
	if want := "quran://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("quran", "about")
	if err != nil || got.String() != "quran://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want quran://page/about", got.String(), err)
	}
}
